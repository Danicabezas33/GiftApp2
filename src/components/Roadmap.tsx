...
const routesByYear: Record<string, LocationInfo[]> = {
  ...
  '2024': [
    { name: 'Madrid (Nuestra Casa)', coords: [40.4168, -3.7038], message: 'Nuestra primera mudanza. Paseos por el Prado, bicis y Manolitos.' },
    { name: 'Algarrobo', coords: [36.7618, -4.0378], message: 'Viaje de aniversario, risas y cuidándote con mucho mimo.' },
    { name: 'Granada', coords: [37.1773, -3.5986], message: 'Sushishom, aguas termales y mojitos de verano.' },
    { name: 'Cádiz', coords: [36.5271, -6.2886], message: 'Forjando recuerdos imborrables con mi familia.' },
