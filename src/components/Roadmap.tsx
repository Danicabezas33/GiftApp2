...
const routesByYear: Record<string, LocationInfo[]> = {
  '2021': [
    ...
    { name: 'La Carihuela', coords: [36.61373621891134, -4.50302054832048], message: 'Playa con mis padres' },
    { name: 'Berlín', coords: [52.5200, 13.4050], message: 'El reencuentro más mágico tras la separación de tu Erasmus.' },
    { name: 'Poznan', coords: [52.405662, 16.931301], message: 'Otro reencuentro mágico.' },
    { name: 'Hotel Loob', coords: [40.4000, -3.5000], message: 'Celebrando tu vuelta definitiva del Erasmus.' },
    { name: 'Granada', coords: [37.186854226533995, -3.6032622002028454], message: 'Nuestro primer viaje juntos, el inicio de muchas escapadas.' },
  ],
  '2022': [
    { name: 'Granada', coords: [37.1773, -3.5986], message: 'Hotel Porcel Sabica.' },
    { name: 'Granada', coords: [37.17487197417253, -3.6010341965561414], message: 'Hotel Porcel Sabica.' },
    { name: 'Cazorla', coords: [37.9135, -3.0039], message: 'Nuestra primera vez explorando juntos la sierra.' },
    { name: 'Granada', coords: [37.17012737780211, -3.59937417799004], message: 'Hotel Porcel Sabica.' },
    ...
    { name: 'Granada', coords: [37.178552425541625, -3.6039572727268845], message: 'Un día de SPA increible en elHotel Senator.' },
  ...
  '2023': [
    ...
    { name: 'Roquetas de Mar', coords: [36.766117, -2.604981], message: 'Apartamento en la costa con objetos dudosos.' },
    ...
    { name: 'La Rijana', coords: [36.709606, -3.391110], message: 'Playa de La Rijana.' },
  ...
  '2024': [
    ...
    { name: 'Fuengirola', coords: [36.541648, -4.624136], message: 'Concierto de Eladio Carrion.' },
    ...
    { name: 'Madrid', coords: [40.43576497480942, -3.68893620068298], message: 'Tu estancia de estudios de peinados.' },
  ...
  '2025': [
    ...
    { name: 'Fuenmayor', coords: [37.75080669017655, -3.5168601429015616], message: 'Buscando la nieve.' },
    ...
    { name: 'SPA', coords: [36.541648, -4.624136], message: 'SPA con vistas a los campos de golf.' },
