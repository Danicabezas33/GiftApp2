...
const routesByYear: Record<string, LocationInfo[]> = {
  '2021': [
    ...
    { name: 'La Carihuela', coords: [36.6117, -4.5042], message: 'Playa con mis padres' },
    ...
    { name: 'Granada', coords: [37.1773, -3.5986], message: 'Nuestro primer viaje juntos, el inicio de muchas escapadas.' },
  ],
  '2022': [
    ...
    { name: 'Granada', coords: [37.1773, -3.5986], message: 'Un día de SPA increible en elHotel Senator.' },
  ...
  '2024': [
    ...
    { name: 'Madrid', coords: [40.4168, -3.7038], message: 'Tu estancia de estudios de peinados.' },
