...
const routesByYear: Record<string, LocationInfo[]> = {
  '2021': [
    ...
    { name: 'Granada', coords: [37.1868, -3.6032], message: 'Una escapada romántica de nuevo a Granada.' },
  ],
  '2022': [
    { name: 'Granada', coords: [37.1773, -3.5986], message: 'Primera visita al Hotel Porcel Sabica.' },
    { name: 'Granada', coords: [37.1748, -3.6010], message: 'Segunda visita al Hotel Porcel Sabica.' },
    { name: 'Cazorla', coords: [37.9135, -3.0039], message: 'Nuestra primera vez explorando juntos la sierra.' },
    { name: 'Granada', coords: [37.1701, -3.5993], message: 'De nuevo visita Hotel Porcel Sabica.' },
    ...
    { name: 'Granada', coords: [37.1785, -3.6039], message: 'Un día de SPA increible en el Hotel Senator.' },
  ...
  '2023': [
    ...
    { name: 'Roquetas de Mar', coords: [36.7661, -2.6049], message: 'Apartamento en la costa con objetos dudosos en el sofá.' },
    { name: 'París', coords: [48.8566, 2.3522], message: 'Nuestro viaje favorito, cumpliendo el sueño que siempre tuviste.' },
  ...
  '2024': [
    ...
    { name: 'Madrid', coords: [40.4357, -3.6889], message: 'Tu estancia independiente en Madrid .' },
